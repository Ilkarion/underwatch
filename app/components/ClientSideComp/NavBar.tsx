...
export default function NavBar() {
    ...
    return(
        <>
            <div className={` flex fixed z-1 flex-row items-center justify-between pr-[5%] pl-[5%] w-full transform transition-all ease-out delay-50 ${scrolled ? 'h-[60px] bg-white' : 'h-[75px] bg-transparent'} 2xl:h-[100px] max-[500px]:hidden`}>
